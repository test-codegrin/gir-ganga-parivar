      ...
      <SmoothScroll>
            ...
            <div className="flex flex-1 items-center justify-center pt-28 sm:pt-32 lg:pt-0">
              <div className="max-w-md sm:max-w-xl lg:max-w-4xl text-center">
                ...
                <p className="mt-4 sm:mt-5 text-white/75 text-sm sm:text-lg lg:text-2xl font-semibold leading-relaxed">
                  Girganga Parivar Trust (GGPT) is a Gujarat-based, NGO-DARPAN
                  and CSR-1 registered organization working at scale to address
                  water scarcity through community-led water conservation
                  structures across drought-prone regions.
                </p>
        ...
        <section className="container mx-auto px-4 py-10">
          ...
          <div className="text-center mb-8">
            <div className="inline-block bg-black text-white text-xl sm:text-2xl font-semibold px-6 py-3 rounded-lg shadow-md shadow-orange-500">
              Explore Our Impact
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg transition-shadow duration-300">
              <div className="flex justify-center mb-2">
                <GiRibbonMedal className="text-orange-500 text-5xl" />
              </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg transition-shadow duration-300">
              <div className="flex justify-center mb-2">
                <FaRegHandshake className="text-orange-500 text-5xl" />
              </div>
              <p className="text-gray-700 font-medium text-center">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg transition-shadow duration-300">
              <div className="flex justify-center mb-2">
                <HiUsers className="text-orange-500 text-5xl" />
              </div>
              <p className="text-gray-700 font-medium text-center">
          ...
          <div className="flex flex-wrap gap-10 mt-6 justify-center">
            <a
              href="/csr-partner"
              className="bg-orange-500 text-white font-semibold px-10 py-4 rounded-lg shadow-md text-xl transition-transform transform hover:-translate-y-1 inline-block text-center"
            >
              Partner With Us (CSR)
            </a>

            <a
              href="/support-structure"
              className="bg-orange-500 text-white font-semibold px-10 py-4 rounded-lg shadow-md text-xl transition-transform transform hover:-translate-y-1 inline-block text-center"
            >
              Support A Structure
            </a>
