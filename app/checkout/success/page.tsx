          ...
          <div className="bg-white rounded-3xl border border-[var(--color-dark)] shadow-sm overflow-hidden">
            ...
            <div className="px-3 lg:px-7 py-7 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2 print-hide">
                ...
                <Link
                  href="/"
                  className="bg-(--color-primary) text-white rounded-xl py-3.5 text-xs font-black uppercase tracking-wider text-center hover:bg-[#007fa3] transition-colors flex items-center justify-center"
                >
                  Go to Home →
                </Link>
              </div>
      ...
      <Suspense fallback={
        <div className="min-h-screen bg-(--color-tertiary) flex items-center justify-center">
          <div className="text-center space-y-3">
            <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-(--color-primary) mx-auto"></div>
